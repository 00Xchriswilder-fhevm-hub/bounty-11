# Confidential Vesting Wallet (patched)

<!-- chapter: openzeppelin -->

## Overview

Fixed permission & conversion handling for FHE operations. This example demonstrates confidential token operations with encrypted balances and transfers and shows how to manage FHE permissions for both contracts and users.
