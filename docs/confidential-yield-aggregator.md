...
A yield-generating mechanism (e.g., lending, staking, liquidity provision)

### 2. Allocation

Encrypted amount of funds allocated to each strategy

### 3. Yield

Encrypted return generated by each strategy

### 4. Rebalancing

Adjusting allocations based on encrypted yield performance

### 5. Compounding

Reinvesting encrypted yields to generate more returns
...
**The Problem:** await expect(
      ...
      ).to.be.revertedWithCustomError(aggrega...
