...
This example shows public decryption with multiple values.
...
### ❌ Pitfall 1: decryption should fail when ABI-encoding is wrongly ordered

**The Problem:** // Test Case: Verify strict ordering is enforced for cryptographic proof generation.
    // The `decryptionProof` is generated based on the exp...
