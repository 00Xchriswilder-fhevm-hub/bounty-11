...
Voting power is automatically tracked when tokens are minted, burned, or transferred. This example implements confidential voting with encrypted vote tracking and delegation.
