...
Concrete factory implementation for creating VestingWalletConfidential clones. This example implements confidential token vesting with encrypted amounts and time-based release.
...
{% tab title="VestingWalletConfidentialFactoryMock.sol" %}
